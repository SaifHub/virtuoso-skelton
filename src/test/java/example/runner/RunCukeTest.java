...
@Suite.SuiteClasses({RunBelly.class, RunWikipedia.class, RunAmazon.class, RunRESTtesting.class})
//RunAmazon.class,RunWikipedia.class, PhilUtils.class, , RunBrowser.class
